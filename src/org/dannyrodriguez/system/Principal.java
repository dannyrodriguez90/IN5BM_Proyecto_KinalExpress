...
import org.dannyrodriguez.controller.MenuDetalleFacturaController;
...
import org.dannyrodriguez.controller.MenuFacturaController;
...
//       escenarioPrincipal.setScene(escena);
    ...
    public void menuPrincipalView() {
        try {
            MenuPrincipalController menuPrincipalView = (MenuPrincipalController) cambiarEscena("MenuPrincipalView.fxml", 600, 370);
    ...
    public void menuClienteView() {
        try {
            MenuClientesController menuClienteView = (MenuClientesController) cambiarEscena("MenuClienteView.fxml", 685, 490);
    ...
    public void menuProgramadorView() {
        try {
            MenuProgramadorController menuProgramadorView = (MenuProgramadorController) cambiarEscena("MenuProgramadorView.fxml", 486, 418);
    ...
    public void menuProveedorView() {
        try {
            MenuProveedorController menuProveedorView = (MenuProveedorController) cambiarEscena("MenuProveedorView.fxml", 760, 500);
    ...
    public void menuTipoDeProductoView() {
        try {
            MenuTipoProductoController menuTipoDeProductoView = (MenuTipoProductoController) cambiarEscena("MenuTipoProductoView.fxml", 618, 437);
    ...
    public void menuComprasView() {
        try {
            MenuComprasController menuComprasView = (MenuComprasController) cambiarEscena("MenuComprasView.fxml", 700, 470);
    ...
    public void menuCargoEmpleadoView() {
        try {
            MenuCargoEmpleadoController menuCargoEmpleadoView = (MenuCargoEmpleadoController) cambiarEscena("MenuCargoEmpleadoView.fxml", 625, 440);
